...
function debounce(t, e, n) {
  ...
  return function() {
    var o = this,
      ...
      u = n && !i;
    clearTimeout(i), i = setTimeout(s, e), u && t.apply(o, r)
  }
}
...
function randomString(t, e) {
  ...
  for (var n = "", i = 0, o = "a" == e ? 10 : 0, r = "n" == e ? 10 : 62; i++ < t;) {
    var s = Math.random() * (r - o) + o << 0;
    n += String.fromCharCode(s += s > 9 ? 36 > s ? 55 : 61 : 48)
  }
  return n
}
angular.module("djds4rce.angular-socialshare", []).factory("$FB", ["$window", function(t) {
  ...
  return {
    ...
    link: function(e, n, i) {
      i.$observe("url", function() {
        i.shares && i.url && t.get("https://api.facebook.com/method/links.getStats?urls=" + i.url.replace(/#/g, '%23') + "&format=json").success(function(t) {
  ...
  return {
    ...
    link: function(i, o, r) {
      ...
      r.$observe("url", s), r.$observe("title", s), r.$observe("summary", s)
    }
  }
